// -- Project -------------------------------------
#define PROJECT                "STU-CONTROL"          // PROJECT is used as the default topic delimiter and OTA file name
                                                 //   As an IDE restriction it needs to be the same as the main .ino file

#define CFG_HOLDER             0x20170801        // [Reset 1] Change this value to load following default configuration parameters
...
#define STA_SSID1              "OWR"      // [Ssid1] Wifi SSID
#define STA_PASS1              "@#vtcs401"  // [Password1] Wifi password
#define STA_SSID2              "Coffee Pha Le"      // [Ssid2] Optional alternate AP Wifi SSID
#define STA_PASS2              "phale112233"  // [Password2] Optional alternate AP Wifi password
...
// -- Syslog --------------------------------------
#define SYS_LOG_HOST           "112.213.84.74"          // [LogHost] địa chỉ máy ghi log linux.
#define SYS_LOG_PORT           514               // [LogPort] port log mặc định (UDP protocol)
...
//#define USE_MQTT_TLS                             // EXPERIMENTAL Use TLS for MQTT connection (+53k code, +20k mem) - Disable by //
...
#ifdef USE_MQTT_TLS
  #define MQTT_HOST            "112.213.84.74"  // [MqttHost]
  ...
  #define MQTT_USER            "cloudmqtt_httu"      // [MqttUser] Mandatory user
  #define MQTT_PASS            "cloudmqtt_httu_password"  // [MqttPassword] Mandatory password
#else
  #define MQTT_HOST            "112.213.84.74"          // [MqttHost]
  #define MQTT_PORT            1883              // [MqttPort] MQTT port (10123 on CloudMQTT)
  #define MQTT_USER            "HTTU"       // [MqttUser] Optional user
  #define MQTT_PASS            "HTTU"       // [MqttPassword] Optional password
#endif
...
#define MQTT_GRPTOPIC          "stu01"         //  [GroupTopic] MQTT Group topic
#define MQTT_CLIENT_ID         "%s_%06X"       // [MqttClient] Also fall back topic using Chip Id = last 6 characters of MAC address
...
#define USE_WEBSERVER                            // Enable web server and wifi manager (+62k code, +8k mem) - Disable by //
  ...
  #define FRIENDLY_NAME        "STU"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
...
#define NTP_SERVER1            "pool.ntp.org"       // [NtpServer1] server cập nhật thời gian 1 (129.250.35.250)
#define NTP_SERVER2            "nl.pool.ntp.org"    // [NtpServer2] server cập nhật thời gian 2 (5.39.184.5)
#define NTP_SERVER3            "0.nl.pool.ntp.org"  // [NtpServer3] server cập nhật thời gian 3 (93.94.224.67)
...
// -- Application ---------------------------------
#define APP_TIMEZONE          +7                 // [Timezone] +1 hour (Amsterdam) (-12 .. 12 = hours from UTC, 99 = use TIME_DST/TIME_STD)
...
#define USE_ADC_VCC                              // Hiển thị điện áp nguồn. Disable khi dùng như chân ADC.

#define USE_DS18x20                              // Tùy chọn dùng thư viện OneWire cho nhiều DS18x20 (+2k code)

//#define USE_I2C                                  // Tùy chọn dùng thư viện I2C (+10k code, 0.2k mem) - Disable by //httu
