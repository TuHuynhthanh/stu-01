...
const char HTTP_ENERGY_SNS[] PROGMEM =
  "<tr><th>Điện áp</th><td>%d V</td></tr>"
  "<tr><th>Dòng</th><td>%s A</td></tr>"
  "<tr><th>Công suất</th><td>%d W</td></tr>"
  "<tr><th>Hệ số công suất</th><td>%s</td></tr>"
  "<tr><th>Hôm nay dùng</th><td>%s kWh</td></tr>"
  "<tr><th>Hôm qua dùng</th><td>%s kWh</td></tr>"
  "<tr><th>Tổng dùng</th><td>%s kWh</td></tr>";
